...
MIDDLEWARE = [
    ...
    'django.middleware.security.SecurityMiddleware',
    'whitenoise.middleware.WhiteNoiseMiddleware',
    'django.contrib.sessions.middleware.SessionMiddleware',  # ← move UP, before CommonMiddleware
    'django.middleware.common.CommonMiddleware',
    'django.middleware.csrf.CsrfViewMiddleware',
    'django.contrib.auth.middleware.AuthenticationMiddleware',
    'django.contrib.messages.middleware.MessageMiddleware',
...
# 5. Database Setup
# Local uses SQLite, but it's ready for Render PostgreSQL via env variable
DATABASES = {
    'default': env.db('DATABASE_URL', default=f'sqlite:///{BASE_DIR}/db.sqlite3')
}

# 6. Storage & Static Files (Django 5.2+ Format)
STORAGES = {
    "default": {
...
# LOGIN_URL           = '/accounts/login/'
# LOGIN_REDIRECT_URL  = '/piling/'           # ← add this
